        ...
        class Game {
            constructor() {
                ...
                this.data = {
                    ...
                    container_ratio: this.selector.game_content.width() /
                ...
                //   }
                // };
                this.render_level = function (level, self) {
                    ...
                    ar.forEach(function (item, index) {
                        ...
                        self.selector.game_cell_box.append("<img style='left: " +
                ...
                this.cell_click = function (cell, self) {
                    if (cell.hasClass("complete") ||
                        ...
                        if (cell.data("image-index") ==
                            this.data.cell_clicked.data("image-index")) {
                            // matched_path = true;
                            matched_path = this.check_has_path(this.cell_to_pointer(this.data.cell_clicked), this.cell_to_pointer(cell));
                        }
                ...
                this.check_has_path_1 = function (pointer_1, pointer_2) {
                        ...
                        while (w_flag) {
                            ...
                            if (pointer_current.x == pointer_1.x &&
                                ...
                                if (this.check_pointer_is_out(pointer_current)) {
                                    ...
                                    if (!this.pointer_to_cell(pointer_current).hasClass("complete")) {
                                        return false;
                                    }
                                }
                            }
                ...
                this.check_has_path_2 = function (pointer_1, pointer_2) {
                    if (pointer_1.x == pointer_2.x || pointer_1.y == pointer_2.y) {
                        return false;
                    }
                    var pointer = {
                ...
                this.check_has_path_3 = function (pointer_1, pointer_2) {
                    if (pointer_1.x != pointer_2.x) {
                ...
                this.check_has_path_of_three = function (pointer_1, pointer_2, pointer_3) {
                ...
                this.check_has_path_of_four = function (pointer_1, pointer_2, pointer_3, pointer_4) {
                    if (!this.check_pointer_is_out(pointer_2)) {
                        if (!this.pointer_to_cell(pointer_2).hasClass("complete")) {
                            return false;
                        }
                ...
                this.check_pointer_is_out = function (pointer) {
                ...
                this.cell_to_pointer = function (cell) {
                    return {
                        x: cell.data("x"),
                        y: cell.data("y"),
                    };
                };
                this.pointer_to_cell = function (pointer) {
                    if (this.check_pointer_is_out(pointer)) {
                        return false;
                    }
                    return $("#cell_" + pointer.x + "_" + pointer.y);
                };
                this.check_has_path = function (pointer_1, pointer_2) {
                ...
                this.get_hint_by_image_index = function (image_index) {
                ...
                this.get_hint = function () {
                    ...
                    if (cell_not_complete.length > 0) {
                        ...
                        if (image_remain.length > 0) {
                            ...
                            for (var i = 0; i < len; i++) {
                                var hint_by_image_index = this.self.get_hint_by_image_index(image_remain[i]);
                ...
                this.unhint = function () {
                    $(".game_cell.hint").removeClass("hint");
                };
                this.auto_random_cell = function () {
                    var hint = false;
                    while (hint == false) {
                        hint = this.get_hint();
                        if (hint == false) {
                ...
                this.refreshGameContainer = function () {
                ...
                this.resize = function () {
                    ...
                    this.refreshGameContainer();
                    var box = {
                        ratio: (this.data.cell_total_h / this.data.cell_total_v) *
                    ...
                    this.selector.btn_hint.click(function (self) {
                        self.hint();
                    });
